// Configuración de la landing de PROMOS DE SETIEMBRE (DryFit Café) — SIMBA Kids UY.
// Copia independiente de la landing principal: cambios acá no afectan esa landing.
window.SIMBA_CONFIG = {
